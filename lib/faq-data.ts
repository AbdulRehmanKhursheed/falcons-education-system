/**
 * FAQ content — single source of truth for the visible FAQ section
 * (components/FAQ.tsx) and the FAQPage JSON-LD (lib/schema.ts).
 * Google requires FAQ markup to match content visible on the page,
 * so both must always come from this list.
 */
