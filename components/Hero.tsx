...
const highlights = [
  { icon: '🌱', text: 'Authentic Montessori Method' },
  { icon: '👩‍🏫', text: 'Trained, Caring Teachers' },
  { icon: '🏫', text: 'Safe, Prepared Environment' },
  { icon: '📍', text: 'Kamalabad Road, Rawalpindi' },
];
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-falcon-sage text-white rounded-full text-sm font-bold shadow-md animate-pulse">
            ...
            <span>Admissions Open 2025 — Limited Seats on Kamalabad Road, Rawalpindi!</span>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-falcon-earth/80 max-w-2xl mx-auto mb-3 text-base sm:text-lg">
            The <strong>best Montessori preschool in Rawalpindi</strong> — located on{' '}
            <strong>Kamalabad Road, Sonari</strong>. Enroll your child in Nursery, Montessori Level,
            or KG and give them the gift of child-centered early childhood education.
          </p>

          {/* NAP — consistent with schema */}
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              ...
              aria-label="Follow Falcons Education System on Instagram"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-falcon-sand rounded-full text-sm font-semibold text-falcon-earth hover:border-falcon-sage hover:text-falcon-sage transition-colors shadow-sm"
              aria-label="Follow Falcons Education System on Facebook"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-falcon-sand rounded-full text-sm font-semibold text-falcon-earth hover:border-falcon-sage hover:text-falcon-sage transition-colors shadow-sm"
              aria-label="Find Falcons Education System on Google Maps"
            >
