...
const navLinks = [
  ...
  { href: '#connect',     label: 'Social Media' },
  { href: '#faq',         label: 'FAQ' },
];

const programs = [
  { label: 'Nursery (Age 2.5–3.5)',        href: '#programs' },
  { label: 'Montessori Level (Age 3–6)',   href: '#programs' },
  { label: 'KG / Kindergarten (Age 4–6)', href: '#programs' },
];
    ...
    <footer className="bg-falcon-sageDark text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Programs */}
          <div>
            <h3 className="font-display font-semibold text-base mb-4">Montessori Programs</h3>
            ...
            <div>
              ...
              <p className="text-white/50 text-xs mt-1">Sat – Sun: Closed</p>
            </div>
          </div>
