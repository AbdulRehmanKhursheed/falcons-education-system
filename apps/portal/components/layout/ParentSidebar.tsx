  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 h-screen sticky top-0 bg-surface border-r border-line">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-5 space-y-6" aria-label="Parent navigation">
              ...
              {kids.map((child) => {
                ...
                return (
                  <li key={child.id}>
                    ...
                    >
                      <Avatar name={child.fullName} size="xs" className={cn(active && '!bg-paper !text-ink')} />
        ...
        {/* School love note */}
        <div className="mx-2 mt-6 rounded-md border border-line-soft bg-surface-2 px-3 py-3">
