...
export const metadata: Metadata = {
  title: "About Us — Montessori Preschool in Rawalpindi",
  description:
    "Learn about Falcons Education System — a Montessori preschool on Kamalabad Road, Rawalpindi. Founded in 2024, we offer child-centered early learning, Saturday coaching, and an evening academy.",
  alternates: { canonical: `${SITE_CONFIG.url}/about` },
  openGraph: {
    title: "About Falcons Education System — Montessori School Rawalpindi",
    description:
      "Authentic Montessori education, Saturday coaching, and evening academy on Kamalabad Road, Rawalpindi. Founded August 2024.",
...
const milestones = [
  ...
  {
    year: "2024",
    event: "Launched Nursery, Montessori Level, and KG programs",
  },
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-falcon-cream to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-falcon-earth text-lg leading-relaxed max-w-2xl mx-auto">
            ...
            with a clear mission: to bring authentic Montessori early childhood
            education to Rawalpindi — rooted in love, respect, and child-led
            discovery.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-falcon-earth leading-relaxed mb-4">
                Our prepared classrooms, Montessori-certified curriculum, and
                qualified teachers help children develop independence,
                confidence, and a genuine love of learning. From practical life
                activities and sensorial exploration to mathematics and language
                — we lay a strong foundation that prepares children for life.
              </p>
              <p className="text-falcon-earth leading-relaxed">
                As our community grew, so did our offerings. We now provide{" "}
                <strong>Saturday Coaching</strong> for weekend academic support
                and an <strong>Evening Academy</strong> for after-school
                homework help and skill building — making Falcons a complete
                education partner for families in Rawalpindi.
              </p>
            </div>
